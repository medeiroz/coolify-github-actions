...
4. Push both tags to GitHub simultaneously:
   ...
   ```
5. *(Optional but Recommended)*: Go to the GitHub repository **Releases** page and click **Draft a new release** using your freshly pushed `v1.0.1` tag to officially list it on the Marketplace.
